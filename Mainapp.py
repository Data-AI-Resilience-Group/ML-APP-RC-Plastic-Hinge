...
This app predicts Plastic Hinge.
...
Ag = st.sidebar.number_input('Cross-sectional area of the column (cm^2)')
columnheight = st.sidebar.number_input("Height of the column (cm)")
...
As = st.sidebar.number_input('Cross-sectional area of the steel reinforcementm^2(c)')
...
Av = st.sidebar.number_input('Av(cm^2)')
